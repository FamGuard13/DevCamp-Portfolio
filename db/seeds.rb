...
Hobby.create!(title: "Watching Sports", icon: "fas basketball-ball fas football-ball")
Hobby.create!(title: "Exercise", icon: "fas running fas dumbbell")
Hobby.create!(title: "Coding", icon: "fas code fas project-diagram")
Hobby.create!(title: "Video Games", icon: "fas mouse far keyboard")
Hobby.create!(title: "Mountain Biking", icon: "fas biking fas mountain")
Hobby.create!(title: "Family", icon: "fas home fas baby")